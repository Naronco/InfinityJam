...
public class Bottle implements Interactable {
    ...
    @Override
    public void look(int x, int y) { Game.instance.showMessage("Eine offene Flasche, die mit Alkohol gefüllt ist.");
    }

    @Override
    public void use(int x, int y) { Game.instance.showMessage("Ich trinke vielleicht später etwas."); }

    @Override
    public void take(int x, int y) { Game.instance.showMessage("Nein, ich möchte keine Flaschen mit mir rumschleppen.");
