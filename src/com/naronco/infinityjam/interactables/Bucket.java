...
public class Bucket implements Interactable {
    ...
    @Override
    public void look(int x, int y) { Game.instance.showMessage("In diesem Eimer kommt mein Schei...uhm, Ko...uhm, Obama rein.");

    }

    @Override
    public void use(int x, int y) { Game.instance.showMessage("Gerade muss ich nicht."); }

    @Override
    public void take(int x, int y) { Game.instance.showMessage("Lieber nicht, den brauche ich lieber noch für Zuhause.");

    }

    @Override
    public void punch(int x, int y) { Game.instance.showMessage("Absolut Ekelhaft.");
    }
