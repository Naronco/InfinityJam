...
public class Hole implements Interactable {
    ...
    @Override
    public void look(int x, int y) { Game.instance.showMessage("Quasi meine Spühlung.");

    }

    @Override
    public void use(int x, int y) { Game.instance.showMessage("Wie jetzt, erwartest du von mir dass ich da rein springe?"); }

    @Override
    public void take(int x, int y) { Game.instance.showMessage("Das Loch sitzt fest an der Wand.");
